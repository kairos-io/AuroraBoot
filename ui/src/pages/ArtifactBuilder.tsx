...
// renderHadronMiddleContent produces the Hadron "middle content": the
// layout-normalizing RUN, one COPY per firmware in spec order, one COPY per
// layer in spec order, and the user's extra content appended verbatim.
// Order matters - later COPYs overwrite earlier files, so sorting would
...
function renderHadronMiddleContent(
  firmware: string[],
  layers: string[],
  extra: string,
): string {
