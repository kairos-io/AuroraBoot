	...
	cases := []tc{
		...
		},
		{
			...
			opts: builder.BuildOptions{
				...
				Dockerfile: "# Generated by AuroraBoot Hadron composer\nRUN echo hi\n",
				Source: builder.ImageSource{
					Arch:  "amd64",
					Model: "generic",
				},
			...
			want: buildv1alpha2.OSArtifactSpec{
				Image: buildv1alpha2.ImageSpec{
					BuildOptions: &buildv1alpha2.BuildOptions{
						Version:   "latest",
						BaseImage: "ghcr.io/kairos-io/hadron:v0.5.1",
						Model:     "generic",
					},
					OCISpec: &buildv1alpha2.OCISpec{
						Ref: &buildv1alpha2.SecretKeySelector{
		...
		{
			name: "Hadron build carries Kairos knobs into BuildOptions",
			opts: builder.BuildOptions{
				HadronBase:    "ghcr.io/kairos-io/hadron:v0.5.1",
				Dockerfile:    "# Hadron middle content\nRUN true\n",
				KairosVersion: "v3.6.0",
				Source: builder.ImageSource{
					Arch:              "arm64",
					Model:             "rpi4",
				...
				Outputs: builder.OutputOptions{ISO: true, FIPS: true, TrustedBoot: true},
			},
			want: buildv1alpha2.OSArtifactSpec{
				Image: buildv1alpha2.ImageSpec{
					BuildOptions: &buildv1alpha2.BuildOptions{
