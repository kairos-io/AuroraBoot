...
// authenticate performs generic RedFish authentication
func (c *GenericClient) authenticate() error {
...
// uploadISO uploads the ISO file to generic temporary storage
func (c *GenericClient) uploadISO(isoPath string) error {
...
// configureBoot configures generic boot settings
func (c *GenericClient) configureBoot() error {
...
// startDeployment initiates the generic deployment process
func (c *GenericClient) startDeployment() (*DeploymentStatus, error) {
	req, err := http.NewRequest("POST",
