...
func GenEFIRawDisk(src, dst string, size uint64, stateSize, systemSize int64, noDefaultCloudConfig, separatePartitionsImages bool) func(ctx context.Context) error {
